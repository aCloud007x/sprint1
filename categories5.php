...
<h1 align="center"><img src="banknote.png" style="height:35px; width:35px; margin-right:15px;">ธนบัตรที่ระลึก</h1>
...
<hr>
	...
	include('connect.php');
		...
		$strSQL = "SELECT Pphoto, Pname, Pprice, Pid FROM product, category WHERE product.cNoType=category.cNoType AND product.cNoType='5' ORDER BY `Pdate` DESC";
		$objQuery = mysqli_query($objConnect, $strSQL) or die ("Error Query [".$strSQL."]");
	?>
