    ...
    <form id="regform" name="regform" >
      ...
      <table style="margin-top:40px; margin-bottom:40px;">
         <tr>
          ...
          pattern="[\d|\w]+[@][\d|\w]+[.][\d|\w]+" required></div></td>
        </tr>
       <tr>
      ...
      <tr>
        <td></td>
        <td><div><input name="btnRegister" id="btnRegister" value="Register" class="btn btn-primary" onclick="Reg()" disabled></div></td>
